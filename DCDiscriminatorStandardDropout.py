...
class DCDiscriminatorStandardDropout(nn.Module):
    '''
    ...
    '''
    def __init__(self, im_chan=3, hidden_dim=64, early_dropout=0.2, mid_dropout = 0.25, late_dropout = 0.3):
        super(DCDiscriminatorStandardDropout, self).__init__()
