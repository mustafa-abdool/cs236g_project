...
def get_pkmn_dataloader(dataloader_name, batch_size, num_workers = 1):
	...
	elif dataloader_name == "conditional_64_no_shiny_mainclass_with_back_sprites_flip_rotate_standard_norm":
		jpg_directory = "./pokemon_images_size=64_shiny=False_incude_back=True_bg=WHITE_mainclass=True_groupclasses=True" 
